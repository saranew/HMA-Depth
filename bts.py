...
class bts(nn.Module):
    ...
    def forward(self, features, focal):
        if self.params.model_ag:
            ...
            final_depth = self.params.max_depth * (reduc1x1*mask4 + depth_2x2_scaled*mask3 + depth_4x4_scaled*mask2 + depth_8x8_scaled*mask1)
        ...
        if self.params.model_ag:
            return depth_8x8_scaled, depth_4x4_scaled, depth_2x2_scaled, reduc1x1, final_depth, mask1, mask2, mask3, mask4
        else:
