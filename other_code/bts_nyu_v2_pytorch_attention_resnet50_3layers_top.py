...
class bts(nn.Module):
    ...
    def forward(self, features, focal):
        if self.params.model_ag:
            ...
            mask2, mask3, mask4 = ag4, (1-ag4)*ag2, (1-ag2)*(1-ag4)

            final_depth = self.params.max_depth * (reduc1x1*mask4 + depth_2x2_scaled*mask3 + depth_4x4_scaled*mask2)
        ...
        if self.params.model_ag:
            return depth_4x4_scaled, depth_4x4_scaled, depth_2x2_scaled, reduc1x1, final_depth, mask2, mask2, mask3, mask4
        else:
